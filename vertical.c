...
float a=0.0f,b=0.0f,c=0.0f,m=0.0f,n=0.0f,o=0.0f,p=0.0f,q=0.0f,r=0.0f,x=0.0f,y=0.0f,z=0.0f,a1=0.0,a2=0.0,a3=0.0,x1=0.0f,x2=0.0f,x3=0.0f;
float j;
//float x4,y4;
//double cloud[3] = {0,0,0};
void *currentfont;
...
cloud(x4+80,y4+10);
    cloud(x4,y4);  
    cloud(x4-10,y4); //up to here for drawing rightmost third cloud
cloud(x4-400,y4+80); // this is for drawing leftmost first cloud
    cloud(x4-200,y4+30); //this is for drawing middle cloud
...
//sun
    ...
    //cloud1
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.5,0.9,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.4,0.95,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.4,0.9,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
   
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.3,0.9,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    //cloud2
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.05,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.01,0.75,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.01,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
   
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(0.007,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
   
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.1,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.1,0.75,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
   
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.15,0.72,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.2,0.8,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.23,0.75,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
     glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.23,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.28,0.75,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    ...
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.6,0.7,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.65,0.65,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.55,0.65,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.7,0.65,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.55,0.68,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(1.5,0.64,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
//cloud4
glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.98,1.0,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.91,0.93,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.88,1.0,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-0.83,0.95,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
    glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-1.0,0.93,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
     glPushMatrix();
    glColor3f(0.937254,0.937254,0.937254);
    glTranslatef(-1.09,0.95,-5.1);
    glutSolidSphere(0.08,20,20);
    glPopMatrix();
...
int main(int argc,char **argv)
{
    ...
    glutCreateWindow("Free way Bridge");
